...
p = varPart %>% 
  ...
  geom_violin(aes(fill = covar, color = covar), scale = "width") +
  ...
  theme_classic()
p
ggsave("d1_d2_rnaseq/figures/variance_partition_fc_2018_07_04/var_explained_darks2_box_small_outs.png",
